...
<?php }else{ 
	...
	<form method="post" action="<?php echo site_url('contact_forms/' . $contact_form['id']);?>" class="contactForm" id="contactForm_<?php echo $contact_form['id'];?>" >
		...
		<?php switch($field['type']){ 
			...
			case "text":                
			    echo '<input class="'.$class.' input" type="'.$field['type'].'" name="field'.$number.'" value="'.$field['value'].'" >'; 
			  break;
			...
			case "textarea":
			    echo '<textarea class="'.$class.' input" name="field'.$number.'" >'.$field['value'].'</textarea>'; 
			  break;
			...
			case "date":
			    echo '<input type="text" class="'.$class.' datepicker input" name="field'.$number.'" value="'.$field['value'].'" >';                    
			  break;
		      } ?>
