...
<div class="gallery">
    ...
    <div class="image_big" id="img_big" >
        
        <div class="navigation" id="next_prev" >
            <span>
    ...
    <img src="<?php echo site_url('gallery/get_image/'.$image['id'].'/600/600');/*$this->Image->getImageUrl($image['id'], 600, 600);base_url('images/'.$image['id'].'.'.$image['ext']);?>" alt="<?php echo $image['title'];*/?>" id="big_image" style="display: none;" >
