...
<div class="gallery">
    ...
    <img src="<?php echo $this->gallery->get_image($image['id'], 600, 600);/*$this->Image->getImageUrl($image['id'], 600, 600);base_url('images/'.$image['id'].'.'.$image['ext']);?>" alt="<?php echo $image['title'];*/?>" id="big_image" style="display: none;" >
